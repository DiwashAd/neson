...
class Themes {
  static const Color primaryColor = Color(0xff2F9E1E);
  ...
  static TextStyle ledgerHead(Color? color) => TextStyle(
  ...
  /// ledger data style
  static TextStyle ledgerData = TextStyle(
    color: Colors.black,
    fontSize: 35.sp,
  ...
  /// ledger total style
  static TextStyle ledgerTotal = TextStyle(
    color: Colors.black,
    fontSize: 35.sp,
    fontWeight: FontWeight.w600,
  );
